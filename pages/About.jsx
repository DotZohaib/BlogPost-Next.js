      ...
      <div>
        <div id="body">
          <div id="tag">
            <h1>I am About</h1>
            <p>
              The Python Tutorial Python is an easy to learn, powerful
              ...
              standard objects and modules, see The Python Standard Library. The
              Python Language Reference gives a more formal definition of the
              language. To write extensions in C or C++, read Extending and
              Embedding the Python Interpreter and Python/C API Reference
